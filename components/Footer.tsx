        ...
        <div className="pt-12">
            <footer id="footer" className="relative z-50 dark:bg-gray-900 pt-24">
                                    ...
                                    <ul>
                                        <li>
                                            <Link href="javascript:void(0)">
                                                <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Facts</a>
                                            </Link>
                                        </li>
                                        <li className="mt-6">
                                            <Link href="javascript:void(0)">
                                                <a className="text-xs lg:text-sm leading-none hover:text-brand dark:hover:text-brand text-gray-800 dark:text-gray-50">Payments</a>
                                            </Link>
                                        </li>
                                        <li className="mt-6">
                                            <Link href="javascript:void(0)">
                            ...
                            <div className="w-full lg:w-1/2 flex">
                                ...
                                <div className="w-full lg:w-1/2 px-6 flex flex-col justify-between">
                                    <div className="flex items-center mb-6">
                                        ...
                                        <a href="https://twitter.com/Andreyscott5">
                                            <div className="pl-4">
                ...
                <div className="py-16 flex flex-col justify-center items-center">
                    ...
                    <p className="mt-6 text-xs lg:text-sm leading-none text-gray-900 dark:text-gray-50">2022 
                    <a href="https://andreyscott.vercel.app"> AndreyScott </a>  Medium</p>
                </div>
            </footer>
        </div>
    );
